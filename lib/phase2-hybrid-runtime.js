(function(global){
  ...
  function buildRuntimeCandidate(options){
    ...
    const firstGuroConnection=deps.rolling.nextConnection(scheduleInput.guro_to_sosa,deps.rolling.addMinutes(origin.arrival_at,deps.rolling.DEFAULT_MIN_TRANSFER_MINUTES));
